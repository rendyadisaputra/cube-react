        ...
        try {
            ...
            if (added > 0) {
                this.logger('Added to queue', {
                    ...
                    preAggregationId: (_a = query.preAggregation) === null || _a === void 0 ? void 0 : _a.preAggregationId,
        ...
        try {
            ...
            if (query) {
                this.logger('Cancelling query manual', {
                    ...
                    metadata: (_a = query.query) === null || _a === void 0 ? void 0 : _a.metadata,
                    preAggregationId: (_c = (_b = query.query) === null || _b === void 0 ? void 0 : _b.preAggregation) === null || _c === void 0 ? void 0 : _c.preAggregationId,
                    newVersionEntry: (_d = query.query) === null || _d === void 0 ? void 0 : _d.newVersionEntry,
                });
            ...
            if (query && insertedCount && activated && processingLockAcquired) {
                ...
                try {
                    ...
                    this.logger('Performing query completed', {
                        ...
                        requestId: query.requestId,
                        timeInQueue,
                        metadata: (_e = query.query) === null || _e === void 0 ? void 0 : _e.metadata,
                        preAggregationId: (_g = (_f = query.query) === null || _f === void 0 ? void 0 : _f.preAggregation) === null || _g === void 0 ? void 0 : _g.preAggregationId,
                        newVersionEntry: (_h = query.query) === null || _h === void 0 ? void 0 : _h.newVersionEntry,
                    });
                }
                catch (e) {
                    executionResult = {
                    ...
                    this.logger('Error while querying', {
                        ...
                        requestId: query.requestId,
                        timeInQueue,
                        metadata: (_j = query.query) === null || _j === void 0 ? void 0 : _j.metadata,
                        preAggregationId: (_l = (_k = query.query) === null || _k === void 0 ? void 0 : _k.preAggregation) === null || _l === void 0 ? void 0 : _l.preAggregationId,
                        newVersionEntry: (_m = query.query) === null || _m === void 0 ? void 0 : _m.newVersionEntry,
                        error: (e.stack || e).toString()
                    });
                    if (e instanceof TimeoutError_1.TimeoutError) {
                        ...
                        if (queryWithCancelHandle) {
                            this.logger('Cancelling query due to timeout', {
                                ...
                                metadata: (_o = queryWithCancelHandle.query) === null || _o === void 0 ? void 0 : _o.metadata,
                                preAggregationId: (_q = (_p = queryWithCancelHandle.query) === null || _p === void 0 ? void 0 : _p.preAggregation) === null || _q === void 0 ? void 0 : _q.preAggregationId,
                                newVersionEntry: (_r = queryWithCancelHandle.query) === null || _r === void 0 ? void 0 : _r.newVersionEntry,
                            });
                ...
                if (!(await redisClient.setResultAndRemoveQuery(queryKey, executionResult, processingId))) {
                    this.logger('Orphaned execution result', {
                        ...
                        queuePrefix: this.redisQueuePrefix,
                        requestId: query.requestId,
                        metadata: (_s = query.query) === null || _s === void 0 ? void 0 : _s.metadata,
                        preAggregationId: (_u = (_t = query.query) === null || _t === void 0 ? void 0 : _t.preAggregation) === null || _u === void 0 ? void 0 : _u.preAggregationId,
                        newVersionEntry: (_v = query.query) === null || _v === void 0 ? void 0 : _v.newVersionEntry,
                    });
                }
                await this.reconcileQueue();
            }
