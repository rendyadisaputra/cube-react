...
class PreAggregations {
    ...
    preAggregationDescriptionFor(cube, foundPreAggregation) {
        ...
        return {
            ...
            preAggregationStartEndQueries: (preAggregation.partitionGranularity || preAggregation.granularity) &&
    ...
    static transformQueryToCanUseForm(query) {
        ...
        function allValuesEq1(map) {
            ...
            for (const v of map === null || map === void 0 ? void 0 : map.values()) {
                if (v !== 1)
                    return false;
            }
            return true;
        ...
        const timeDimensions = query.timeDimensions && ramda_1.default.sortBy(ramda_1.default.prop(0), query.timeDimensions.map(d => [d.dimension, d.granularity])) || [];
        const hasNoTimeDimensionsWithoutGranularity = !query.timeDimensions.filter(d => !d.granularity).length;
        const allFiltersWithinSelectedDimensions = ramda_1.default.all(d => dimensionsList.indexOf(d) !== -1)(query.filters.map(f => f.dimension));
        ...
        filterDimensionsSingleValueEqual = new Set(allValuesEq1(filterDimensionsSingleValueEqual) ? filterDimensionsSingleValueEqual === null || filterDimensionsSingleValueEqual === void 0 ? void 0 : filterDimensionsSingleValueEqual.keys() : null);
        return {
            sortedDimensions,
        ...
        const canUsePreAggregationNotAdditive = (references) => {
            ...
            return transformedQuery.hasNoTimeDimensionsWithoutGranularity &&
                (references.dimensions.length === transformedQuery.filterDimensionsSingleValueEqual.size &&
                    ramda_1.default.all(d => transformedQuery.filterDimensionsSingleValueEqual.has(d), references.dimensions)) &&
                ...
                ramda_1.default.equals(transformedQuery.sortedTimeDimensions, sortedTimeDimensions) &&
                (transformedQuery.isAdditive || ramda_1.default.equals(transformedQuery.timeDimensions, sortedTimeDimensions)) &&
