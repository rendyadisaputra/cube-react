...
exports.CubeValidator = exports.functionFieldsPatterns = void 0;
...
const MeasuresSchema = Joi.object().pattern(identifierRegex, Joi.alternatives().conditional(Joi.ref('.type'), [
    ...
    {
        is: Joi.string().valid('number', 'sum', 'avg', 'min', 'max', 'countDistinct', 'runningTotal', 'countDistinctApprox'),
        then: inherit(BaseMeasure, {
            sql: Joi.func().required(),
            type: Joi.any().valid('number', 'sum', 'avg', 'min', 'max', 'countDistinct', 'runningTotal', 'countDistinctApprox').required()
        }),
        otherwise: Joi.object().keys({
            type: Joi.string().valid('count', 'number', 'sum', 'avg', 'min', 'max', 'countDistinct', 'runningTotal', 'countDistinctApprox').required()
        })
    }
]));
/* *****************************
...
function formatErrorMessageFromDetails(explain, d) {
    ...
    if ((_a = d === null || d === void 0 ? void 0 : d.context) === null || _a === void 0 ? void 0 : _a.details) {
        (_c = (_b = d === null || d === void 0 ? void 0 : d.context) === null || _b === void 0 ? void 0 : _b.details) === null || _c === void 0 ? void 0 : _c.forEach((d2) => formatErrorMessageFromDetails(explain, d2));
    }
    else if (d === null || d === void 0 ? void 0 : d.message) {
        const key = ((_d = d === null || d === void 0 ? void 0 : d.context) === null || _d === void 0 ? void 0 : _d.message) || (d === null || d === void 0 ? void 0 : d.message);
        const val = key === null || key === void 0 ? void 0 : key.replace(`"${(_e = d.context) === null || _e === void 0 ? void 0 : _e.label}"`, `(${(_f = d.context) === null || _f === void 0 ? void 0 : _f.label} = ${(_g = d.context) === null || _g === void 0 ? void 0 : _g.value})`);
        explain.set(key, val);
    }
}
function formatErrorMessage(error) {
    ...
    (_a = error === null || error === void 0 ? void 0 : error.details) === null || _a === void 0 ? void 0 : _a.forEach((d) => formatErrorMessageFromDetails(explain, d));
...
function collectFunctionFieldsPatterns(patterns, path, o) {
    var _a, _b, _c;
    let key = (o === null || o === void 0 ? void 0 : o.id) || (o === null || o === void 0 ? void 0 : o.key) || ((((_a = o === null || o === void 0 ? void 0 : o.patterns) === null || _a === void 0 ? void 0 : _a.length) || 0) > 0 ? '*' : undefined);
    if (((_b = o === null || o === void 0 ? void 0 : o.schema) === null || _b === void 0 ? void 0 : _b.type) === 'array' && key && typeof key === 'string') {
        key = `${key}.0`;
    }
    // eslint-disable-next-line no-nested-ternary
    const newPath = key && typeof key === 'string' ? (path.length > 0 ? `${path}.${key}` : key) : path;
    if (((_c = o === null || o === void 0 ? void 0 : o.schema) === null || _c === void 0 ? void 0 : _c.type) === 'function') {
